...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(13),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _speech = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function speeches() {
	  ...
	  switch (action.type) {
	    case _ActionTypes.ADD_SPEECH:
	      return [].concat(_toConsumableArray(state), [action.speech]);
...
/***/ function(module, exports) {
	...
	var ADD_SPEECH = exports.ADD_SPEECH = 'ADD_SPEECH';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _speeches = __webpack_require__(37);

	var SpeechActions = _interopRequireWildcard(_speeches);
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    actions: (0, _redux.bindActionCreators)(SpeechActions, dispatch)
	  };
	}

	exports.default = (0, _reactRedux.connect)(function (state) {
	  return state;
	}, mapDispatchToProps)(_Window2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Speech = __webpack_require__(32);

	var _Speech2 = _interopRequireDefault(_Speech);

	var _Record = __webpack_require__(34);
	...
	var Window = function (_Component) {
	  ...
	  _createClass(Window, [{
	    ...
	    value: function componentDidMount() {
	      var addSpeech = this.props.actions.addSpeech;
	    ...
	    value: function componentDidUpdate() {
	      ...
	      var speeches = this.props.speeches;
	      var lastSpeech = speeches[speeches.length - 1];
	      var replySpeech = this.props.actions.replySpeech;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'absolute-center mobile' },
	        _react2.default.createElement(
	          'div',
	          { className: 'screen', ref: 'screen' },
	          _lodash2.default.map(this.props.speeches, function (speech) {
	            return _react2.default.createElement(_Record2.default, { key: speech.id, speech: speech });
	          })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Speech = function (_Component) {
	  ...
	  function Speech() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Speech).apply(this, arguments));
	  }
	  ...
	  _createClass(Speech, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'p',
	        { className: (0, _classnames2.default)({ speech: true, 'speech-left': !user }) },
	        content
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Record = function (_Component) {
	  ...
	  _createClass(Record, [{
	    key: 'render',
	    value: function render() {
	      var speech = this.props.speech;

	      return _react2.default.createElement(
	        'div',
	        { className: 'record clearfix' },
	        _react2.default.createElement(_Speech2.default, { content: speech.content, user: speech.user })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.replySpeech = replySpeech;

	var _ActionTypes = __webpack_require__(29);

	var types = _interopRequireWildcard(_ActionTypes);

	var _bot = __webpack_require__(38);
	...
	function addSpeech(speech) {
	  return { type: types.ADD_SPEECH, speech: speech };
	};

	function replySpeech(speech) {
	  return function (dispatch) {
	    return (0, _bot2.default)(speech).then(function (speech) {
	      return dispatch(addSpeech(speech));
	    });
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var speechMap = {};
	speeches.reduce(function (map, speech) {
	  map[speech.id] = speech;
	  return map;
	}, speechMap);

	function bot(preSpeech) {
	  var reply = speechMap[preSpeech.next];
	  var delay = reply.delay || DEFAULT_DELAY;
